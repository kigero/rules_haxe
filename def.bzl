...
load("//:rules.bzl", _haxe_executable = "haxe_executable", _haxe_gen_hxml = "haxe_gen_hxml", _haxe_library = "haxe_library", _haxe_project_definition = "haxe_project_definition", _haxe_test = "haxe_test", _haxelib_install = "haxelib_install")
